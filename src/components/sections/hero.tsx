...
export function Hero() {
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.93)_0%,rgba(255,255,255,0.82)_43%,rgba(255,255,255,0.55)_72%,rgba(255,255,255,0.28)_100%)] lg:bg-[linear-gradient(90deg,#ffffff_0%,rgba(255,255,255,0.94)_38%,rgba(255,255,255,0.52)_62%,rgba(255,255,255,0.04)_100%)]" />
