      ...
      <div className="mx-auto grid max-w-2xl gap-4">
        ...
        <section className="rounded-2xl border border-border bg-white p-4 shadow-sm sm:p-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <Link
              href={invoiceHref}
              className="inline-flex w-full justify-center rounded-xl border border-primary/15 bg-white px-4 py-3 text-sm font-black text-primary transition hover:bg-primary/5 sm:w-auto"
            >
              Back to invoice
            </Link>
          </div>
